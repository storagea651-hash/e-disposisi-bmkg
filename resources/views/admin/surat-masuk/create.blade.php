        ...
        <form action="{{ route('admin.surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="surat_dari" id="surat_dari" value="{{ old('surat_dari') }}" 
                ...
                <div>
                    ...
                    <input type="date" name="diterima_tanggal" id="diterima_tanggal" value="{{ old('diterima_tanggal', date('Y-m-d')) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="no_agenda" id="no_agenda" value="{{ old('no_agenda') }}" 
